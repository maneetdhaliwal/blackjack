...
public class BlackJack {
    ...
    public void starter() {
        ...
        while (choice != 3) {
            ...
            System.out.println("Press 1 to Play. 2 to check balance. 3 to quit.");
        choice = scan.nextInt();
        if (choice == 2) {
            System.out.println(wager.getBalance());
        }
        ...
        while (!turnOff) {
            ...
            if (input == 1) {
                ...
                if (sum > 21) {
                    System.out.println("Bust! You are out!");
            ...
            if (input == 2) {
                ...
                while (!winner) {
                    ...
                    if (sum == 21) {
                        System.out.println(wager.BlackJack());
                        wager.BlackJack();
                        winner = true;
                        break;
                    }
            ...
            if (input == 3) {
                ...
                if (sum > 21) {
                    System.out.println("Bust! Opp has won!");
                    wager.Loss();
                    turnOff = true;
                    break;
                }
